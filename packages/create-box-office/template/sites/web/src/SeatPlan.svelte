<script lang="ts">
  import { Section } from '@the-gods/box-office/web/components'
  import { Row } from '@the-gods/box-office/web/components'
  import { Seat } from '@the-gods/box-office/web/components'
